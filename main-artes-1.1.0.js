...
function start_countdown_timer(duration, display_minutes, display_seconds, display_banner) {
    ...
    window.addEventListener('load', function() {
        ...
        checkElement('#app').then((selector) => {
            ...
            if(localStorage.getItem('banner_countdown') !== null){
                ...
                if((actual_datetime - banner_countdown_fields.datetime) >= (60000 * 60 * 1)){
                    var duration = 60 * 20;
            ...
            console.log('#banner com countdown adicionado');
        });
...
function loading_on_product_page() {
    ...
    checkElement('.main-product-info .main-product-buy-button-holder').then((selector) => {
        ...
        document.querySelector('.main-product-info .main-product-buy-button-holder').insertAdjacentHTML('afterend', '<p class="prod-current-seller" id="sold-by">Vendido e enviado por <span class="text-primary">ON ARTES</span></p>');
        ...
        const numero_maximo = 487,
            numero_minimo = 227;
        document.querySelector('.main-product-info .main-product-buy-button-holder').insertAdjacentHTML('afterend', '<div class="store-info-bar" style="order:8;display:flex;justify-content:space-between;margin:0 0 25px;padding:10px 0;border:1px solid #e7e7e7;border-radius:10px"><div style="border-right:1px solid #d1d1d1;justify-items:center;flex-basis:100%;display:flex;-webkit-flex-direction:column;flex-direction:column;-webkit-align-items:center;align-items:center;text-align:center;position:relative;padding:8px"><span style="font-size:22px;font-weight:400">' + Math.floor(Math.random() * (numero_maximo - numero_minimo + 1) + numero_minimo) + '</span><p style="font-size:12px;line-height:1.3;text-align:center;color:#696969;font-weight:400">Produtos adquiridos nos últimos 7 dias</p></div><div style="justify-items:center;flex-basis:100%;display:flex;-webkit-flex-direction:column;flex-direction:column;-webkit-align-items:center;align-items:center;text-align:center;position:relative;padding:8px"><span style=""><svg viewBox="0 0 29 24" xmlns="http://www.w3.org/2000/svg" style="width:27px"><g fill-rule="evenodd" fill="none"><path d="M6.747 21.511l4.538-3.518h8.238c1.032 0 1.868-.98 1.868-2.19V3.21c0-1.21-.836-2.19-1.868-2.19H3.173c-1.032 0-1.869.98-1.869 2.19v14.077c0 .39.316.706.706.706H5.61v2.96a.706.706 0 0 0 1.138.558z" stroke-width="1.5" stroke="#333"></path><g transform="translate(14 9)"><circle cx="7.5" cy="7.5" r="7.5" fill="#39B54A"></circle><g stroke-linecap="round" stroke-width="1.059" stroke="#FFF"><path d="M3.75 7.5l2.445 2.445M6.25 9.89L11.14 5"></path></g></g></g></svg></span><p style="font-size:12px;line-height:1.3;text-align:center;color:#696969;font-weight:400">Presta um bom atendimento</p></div><div style="border-left:1px solid #d1d1d1;justify-items:center;flex-basis:100%;display:flex;-webkit-flex-direction:column;flex-direction:column;-webkit-align-items:center;align-items:center;text-align:center;position:relative;padding:8px"><span><svg viewBox="0 0 30 26" xmlns="http://www.w3.org/2000/svg" style="width:27px"><g fill-rule="evenodd" fill="none"><g transform="translate(1 .02)" stroke="#333"><ellipse cx="10.5" cy="13.714" rx="10.5" ry="10.286" stroke-width="1.286"></ellipse><path d="M19.107 13.714h-1.59M3.42 13.714H1.83M10.5 5.143v1.59M10.563 20.571v1.59M10.5.857v2.484M8.75.857h3.637M10.313 8.801v4.944H5.24" stroke-linecap="round" stroke-width="1.102"></path></g><g transform="translate(15 10.02)"><circle cx="7.5" cy="7.5" r="7.5" fill="#39B54A"></circle><g stroke-linecap="round" stroke-width="1.059" stroke="#FFF"><path d="M3.75 7.5l2.445 2.445M6.25 9.89L11.14 5"></path></g></g></g></svg></span><p style="font-size:12px;line-height:1.3;text-align:center;color:#696969;font-weight:400">Envios de forma rápida e eficiente</p></div></div>');
    ...
    checkElement('.shipping-preview-line').then((selector) => {
        document.querySelector('.shipping-preview-line').insertAdjacentHTML('afterend', '<div class="seguranca-e-garantia" style="margin-top: 20px;margin-bottom: 25px;order: 8;box-shadow: 0 10px 30px -10px #0000002e;border-radius: 7px;padding: 15px;"><span style="font-size: 13px;color: #696969;display: flex;"><i style="vertical-align: middle;"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" style="width: 18px;height: 18px;margin: 0 10px 0 0;margin-top: 4px;fill: #248430;"> <defs><style>.b306b133-4171-4324-a7a6-35edefba34cf{fill:#248430}.ee141ce0-902f-4815-8c10-0060f9589c50{fill:#fff}</style></defs><path class="b306b133-4171-4324-a7a6-35edefba34cf" d="M1.3,4.3V3.7h.6A8.9,8.9,0,0,0,7.6,1.3L8,1l.4.3a8.9,8.9,0,0,0,5.7,2.4h.6v.6c0,5.6-2.2,9.2-6.5,10.7H7.8C3.5,13.5,1.3,9.9,1.3,4.3Z" transform="translate(-1.3 -1)"></path><polygon class="ee141ce0-902f-4815-8c10-0060f9589c50" points="5.8 8 8.9 4.4 9.8 5.2 5.8 9.8 3.4 7.4 4.2 6.5 5.8 8"></polygon> </svg></i><span style="line-height: 1.4"><strong style="color: #3bb54a">Qualidade Garantida.</strong> Todas as artes foram desenvolvidas com a mais alta qualidade.</span> </span><span style="color: #696969;font-size: 13px;margin-top: 10px;display: flex;"><i style="vertical-align: middle;"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" style="width: 18px;height: 18px;margin: 0 10px 0 0;margin-top: 4px;fill: #248430;"> <path d="M10.81,1.67c.49,0,.98,0,1.47,0,1.28.02,2.16.89,2.17,2.17.01,1.03,0,2.06,0,3.09,0,.35-.12.64-.38.89-2.09,2.09-4.18,4.18-6.28,6.27-.51.51-1.12.5-1.63,0-1.38-1.38-2.76-2.75-4.13-4.13-.52-.52-.52-1.13,0-1.65,2.08-2.09,4.17-4.17,6.25-6.26.26-.26.55-.39.92-.38.53,0,1.06,0,1.59,0ZM12.33,2.74c-.6,0-1.07.48-1.07,1.06,0,.58.5,1.07,1.08,1.06.58,0,1.04-.48,1.05-1.06,0-.6-.46-1.07-1.06-1.07Z" stroke-width="0"></path></svg></i><span style="line-height: 1.4;"><strong style="color: #3bb54a">Menor Perço.</strong> Garantimos que temos o menor preço do mercado de artes!</span> </span><span style="color: #696969;font-size: 13px;margin-top: 10px;display: flex;"><i style="vertical-align: middle;"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="15" viewBox="0 0 14 15" style="width: 18px;height: 18px;margin: 0 10px 0 0;margin-top: 4px;fill: #248430;"> <path d="M6.19,3.64c.55-.28,1.05-.62,1.6-.78,1.98-.59,3.8.89,3.69,2.95-.02.39-.15.47-.52.32-1.33-.54-2.59-.41-3.73.46-1.28.98-1.63,2.65-.92,4.19.09.2.19.41.32.58.14.19.08.31-.06.45-.2.2-.52.26-.74.06-1.42-1.29-3-2.43-4.07-4.07-.42-.63-.73-1.32-.75-2.09-.06-2.29,2.29-3.69,4.36-2.6.3.16.58.37.82.53Z" stroke-width="0"></path><path d="M9.55,7.06c.46,0,.94.15,1.36.45.19.14.32.15.53,0,.65-.46,1.38-.58,2.14-.37,1.29.35,1.93,1.65,1.44,2.92-.32.83-.9,1.48-1.55,2.05-.61.53-1.24,1.03-1.87,1.54-.23.19-.5.25-.74.06-1-.79-2.06-1.53-2.86-2.55-.4-.5-.73-1.05-.8-1.7-.14-1.37.86-2.41,2.35-2.42Z" stroke-width="0"></path></svg></i><span style="line-height: 1.4;"><strong style="color: #3bb54a">+10 mil clientes.</strong> Com mais de 5 anos no mercado, temos +10 mil clientes satisfeitos.</span> </span></div>');
        console.log('#mensagem de segurança e clientes adicionado');
    });
    ...
    /* begin:: Selos de segurança */
    checkElement('.footer').then((selector) => {
        document.querySelector('.footer').insertAdjacentHTML('beforebegin', '<section class="selos-seguranca banner-3" style="margin-bottom: -30px;margin-top: 50px;"><div class="holder-banner-3 container relative"><div class="flex"><div class="flex banner"><div> <svg id="b9fc2764-b1ea-4f95-950c-34e5a7681c67" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" width="60.5" height="53.3" viewBox="0 0 60.5 53.3"><title>receba-em-casa-selo</title><g id="a85833d7-f191-4087-a6d1-2e34f6109de5" data-name="Desktop"><g id="b9d3a989-89f8-40c4-bed8-1a361304dc07" data-name="Home V1"><g id="a73b2c51-d21e-4683-80d6-5980a02a62f2" data-name="Footer"><g id="f5a7fd43-ebc4-42fc-925e-0fe0a95e2a50" data-name="Group-41"><g id="e02249f4-a6b0-4cb9-8d2d-ee6c0b1b53b0" data-name="Envio"><g id="bd212004-d75a-4b2e-b024-b7a0fc88f57a" data-name="Group-16"><rect id="e8093c93-6b5d-4f2d-a6b0-bbabb294a49a" data-name="Rectangle-193" x="1.3" y="1.3" width="58" height="10.44" rx="2" fill="none" stroke="#191919" stroke-width="2.5"></rect><path id="af90b712-6651-40e4-87cf-69f9ab214a0b" data-name="Rectangle-194" d="M5.1,18.9H57.9v39h0a1.3,1.3,0,0,1-1.3,1.4H6.5a1.4,1.4,0,0,1-1.4-1.4Z" transform="translate(-1.8 -7.2)" fill="none" stroke="#191919" stroke-width="2.5"></path><polygon id="aca30934-6164-4025-80a4-1bfb327ecf9e" data-name="Fill-9" points="24.9 23.3 26.6 21.5 28.4 23.3 30.2 21.5 31.9 23.3 33.7 21.5 35.4 23.3 35.4 10.9 24.9 10.9 24.9 23.3" style="fill: var(--color-general-primary);filter: brightness(0.9)" fill-rule="evenodd"></polygon><rect id="e3637387-6aa1-4c69-8d5a-addf5d5446c1" data-name="Rectangle-195" x="24.9" y="0.5" width="10.5" height="11.19" style="fill: var(--color-general-primary);filter: brightness(0.9)"></rect><g id="bc64bbe0-cc8b-45b1-86a2-8177eecb457a" data-name="Group-12"><path id="af4d7e3b-fe61-4335-8a93-13534d82f509" data-name="Fill-15" d="M30.8,54.6H11a.5.5,0,0,1-.5-.5V43.4a.6.6,0,0,1,.5-.6H30.8a.6.6,0,0,1,.5.6V54.1a.5.5,0,0,1-.5.5" transform="translate(-1.8 -7.2)" fill="none" stroke="#191919" stroke-width="2" fill-rule="evenodd"></path><path id="ef7ee9e2-4be7-424a-8210-ff3809696cec" data-name="Fill-16" d="M15.4,48.8a.8.8,0,0,1-.7-.3.7.7,0,0,1-.2-.6.9.9,0,1,1,.9.9m0-3.3a2.5,2.5,0,0,0-2.5,2.4,2.5,2.5,0,0,0,.4,1.3L15.4,52l2.1-2.8a2.5,2.5,0,0,0,.4-1.3,2.5,2.5,0,0,0-2.5-2.4" transform="translate(-1.8 -7.2)" fill="#191919" fill-rule="evenodd"></path><path id="a6e827d9-886d-4320-b5a4-fabbe4b15f43" data-name="Fill-17" d="M20.4,46.8H27a.7.7,0,0,0,.7-.7h0a.7.7,0,0,0-.7-.6H20.4a.7.7,0,0,0-.7.6h0A.7.7,0,0,0,20.4,46.8Z" transform="translate(-1.8 -7.2)" fill="#191919" fill-rule="evenodd"></path><path id="a76236e7-1ad2-4da4-867a-58ece364c223" data-name="Fill-18" d="M20.4,49.4H25a.7.7,0,0,0,.7-.7h0a.7.7,0,0,0-.7-.6H20.4a.7.7,0,0,0-.7.6h0A.7.7,0,0,0,20.4,49.4Z" transform="translate(-1.8 -7.2)" fill="#191919" fill-rule="evenodd"></path><path id="ee216a4c-af5a-4c6f-9781-632363913652" data-name="Fill-19" d="M20.4,52h5.3a.7.7,0,0,0,.6-.7h0a.6.6,0,0,0-.6-.6H20.4a.7.7,0,0,0-.7.6h0A.7.7,0,0,0,20.4,52Z" transform="translate(-1.8 -7.2)" fill="#191919" fill-rule="evenodd"></path></g></g></g></g></g></g></g></svg></div><div class="block" style="margin-left: 15px;margin-right: 5px;"> <span class="block" style="font-weight: 600;font-size: 14px;">Artes exclusivas e personalizadas</span> <span class="block" style="margin-top: 2px;font-size: 13px;">Trabalhamos com artes de altíssima qualidade, preço baixo e sofisticação</span></div></div><div class="flex banner"><div> <svg id="bb51f0a5-15c5-4de7-9e0e-37b89194541c" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="60.6" height="58.4" viewBox="0 0 60.6 58.4"><defs><mask id="a8dcdce0-cf35-40c8-811e-ad1d7548ce30" x="0" y="0" width="60.59" height="41.81" maskUnits="userSpaceOnUse"><g transform="translate(-1.2 -5.9)"><g id="a565e7c0-7f02-4ebd-a32c-1ed050b238f8" data-name="mask-2"><polygon id="a4ddd7de-6f9e-4b63-ba4c-28c88f5e9a4b" data-name="path-1" points="61.1 47 2 47 2 6.7 61.1 6.7 61.1 47" fill="#fff" fill-rule="evenodd"></polygon></g></g></mask></defs><title>pagamento-seguro-selo</title><g id="e5706853-e815-4df2-a8d5-006759ddc413" data-name="Desktop"><g id="ed3a7d9d-ca1f-44f2-b238-b295dcd0f013" data-name="Home V1"><g id="adee5aaa-0a9f-4cd7-98b0-f29a0037169e" data-name="Footer"><g id="a1736b67-db1e-4751-b60a-cfdc37654e68" data-name="Group-42"><g id="b4bd78e5-f2ea-431c-9f4c-1b00572e2c4b" data-name="Pago"><g id="a01625a5-ce8d-47da-a08d-4fa09bab8700" data-name="Group-17"><g id="aeeb611b-06ec-4812-8738-b1acfa7af3f4" data-name="Group-10"><path id="a35595c8-3f46-425c-9b99-32d174fe9eb8" data-name="Fill-1" d="M2.8,10.2A2.7,2.7,0,0,1,5.6,7.5H57.5a2.8,2.8,0,0,1,2.8,2.7V43.5a2.8,2.8,0,0,1-2.8,2.7H5.6a2.7,2.7,0,0,1-2.8-2.7Z" transform="translate(-1.2 -5.9)" fill="none" fill-rule="evenodd"></path><g id="adb801d1-799e-4548-b13c-7480cc21dac1" data-name="Group-5"><g mask="url(#a8dcdce0-cf35-40c8-811e-ad1d7548ce30)"><path id="aad36856-9b8f-4866-a753-97ad19d0c965" data-name="Fill-3" d="M5.6,8.3a1.9,1.9,0,0,0-2,1.9V43.5a1.9,1.9,0,0,0,2,1.9H57.5a1.8,1.8,0,0,0,1.9-1.9V10.2a1.8,1.8,0,0,0-1.9-1.9ZM5.6,47A3.6,3.6,0,0,1,2,43.5V10.2A3.6,3.6,0,0,1,5.6,6.7H57.5a3.6,3.6,0,0,1,3.6,3.5V43.5A3.6,3.6,0,0,1,57.5,47Z" transform="translate(-1.2 -5.9)" fill="#191919" stroke="#191919" stroke-miterlimit="10" stroke-width="1.5" fill-rule="evenodd"></path></g></g><path id="b507deef-8795-4fd5-ae6f-eef5e1e1f069" data-name="Fill-6" d="M17.5,20.6a4,4,0,1,0,0-8,4.1,4.1,0,0,0-4.2,4,4.1,4.1,0,0,0,4.2,4" transform="translate(-1.2 -5.9)" fill="none" fill-rule="evenodd"></path><path id="a907fff4-9127-422f-b521-3e1325551578" data-name="Fill-8" d="M17.5,13.4a3.2,3.2,0,1,0,0,6.4,3.2,3.2,0,1,0,0-6.4m0,8a4.9,4.9,0,0,1-5-4.8,4.8,4.8,0,0,1,5-4.8,4.9,4.9,0,0,1,5,4.8,5,5,0,0,1-5,4.8" transform="translate(-1.2 -5.9)" fill="#191919" fill-rule="evenodd"></path></g><g id="f3747952-8c8a-4cdb-a874-bdd2c224271f" data-name="Group-43"><path id="a161e30f-b8ce-4ee7-9aeb-07d804b1e2f4" data-name="Fill-13" d="M11.5,21.1a4.6,4.6,0,0,0,4.7-4.5,4.7,4.7,0,0,0-9.4,0,4.6,4.6,0,0,0,4.7,4.5" transform="translate(-1.2 -5.9)" style="fill: var(--color-general-primary);filter: brightness(0.9)" fill-rule="evenodd"></path><path id="e48b6215-ca6d-4663-91b7-fedea9f981cc" data-name="Fill-17" d="M15.3,28.6H8a.8.8,0,0,1-.9-.8A.9.9,0,0,1,8,27h7.3a.9.9,0,0,1,.8.8.8.8,0,0,1-.8.8" transform="translate(-1.2 -5.9)" fill="#191919" fill-rule="evenodd"></path><path id="baaf3d29-9682-4a19-b171-c40deffc08e9" data-name="Fill-21" d="M12.4,37.1H7.1a.5.5,0,0,1-.5-.5.5.5,0,0,1,.5-.5h5.3a.5.5,0,0,1,.5.5.5.5,0,0,1-.5.5" transform="translate(-1.2 -5.9)" fill="#191919" fill-rule="evenodd"></path><path id="e54c7df4-9554-4ac8-9104-616f9fcc0369" data-name="Fill-25" d="M23.7,37.1H16.4a.6.6,0,0,1-.6-.5.6.6,0,0,1,.6-.5h7.3a.5.5,0,0,1,.5.5.5.5,0,0,1-.5.5" transform="translate(-1.2 -5.9)" fill="#191919" fill-rule="evenodd"></path><path id="f9161f25-116c-47a1-a14b-9da4d3847ac9" data-name="Fill-29" d="M20.7,40.4H7.1a.5.5,0,0,1,0-1H20.7a.5.5,0,0,1,0,1" transform="translate(-1.2 -5.9)" fill="#191919" fill-rule="evenodd"></path><path id="b8f49b7d-6f64-423c-8804-e452d45f72b7" data-name="Fill-33" d="M28.2,28.6H20.9a.8.8,0,0,1-.9-.8.9.9,0,0,1,.9-.8h7.3a.9.9,0,0,1,.8.8.8.8,0,0,1-.8.8" transform="translate(-1.2 -5.9)" fill="#191919" fill-rule="evenodd"></path><path id="a8ded640-741a-4b2e-a7ed-5912494d3e73" data-name="Fill-37" d="M41.1,28.6H33.8a.8.8,0,0,1-.9-.8.9.9,0,0,1,.9-.8h7.3a.9.9,0,0,1,.8.8.8.8,0,0,1-.8.8" transform="translate(-1.2 -5.9)" fill="#191919" fill-rule="evenodd"></path><path id="b3519f18-dd9a-4fb3-9b16-b13f5c22227a" data-name="Fill-41" d="M54.2,28.6H46.5a.8.8,0,0,1-.8-.8.9.9,0,0,1,.8-.8h7.7a.9.9,0,0,1,.8.8.8.8,0,0,1-.8.8" transform="translate(-1.2 -5.9)" fill="#191919" fill-rule="evenodd"></path></g></g></g></g></g></g></g><rect x="32.3" y="39.9" width="20" height="17" rx="1" fill="none" style="stroke: var(--color-general-primary);filter: brightness(0.9)" stroke-linecap="square" stroke-width="3"></rect><path d="M38.6,45.7V40.6a5.1,5.1,0,0,1,10.2,0v5.1" transform="translate(-1.2 -5.9)" fill="none" style="stroke: var(--color-general-primary);filter: brightness(0.9)" stroke-linecap="square" stroke-width="3"></path><line x1="42.5" y1="47.4" x2="42.5" y2="50" fill="none" style="stroke: var(--color-general-primary);filter: brightness(0.9)" stroke-linecap="square" stroke-width="3"></line></svg></div><div class="block" style="margin-left: 15px;margin-right: 5px;"> <span class="block" style="font-weight: 600;font-size: 14px;">Escolha como pagar</span> <span class="block" style="margin-top: 2px;font-size: 13px;">Pague sua compra de forma segura com boleto bancário, pix ou cartão de crédito</span></div></div><div class="flex banner"><div> <svg id="a969efb4-3207-4c6f-93c1-c4255184b22c" data-name="Camada 1" xmlns="http://www.w3.org/2000/svg" width="54.2" height="57.6" viewBox="0 0 54.2 57.6"><title>reembolso-selo</title><g id="ef0a8b4d-3633-452c-992e-4c8bf9dbed30" data-name="Desktop"><g id="bcbf4a0e-8487-42e3-ae30-4335143bd100" data-name="Home"><g id="bbd4fccf-b7bf-4c99-8a3e-d9f7f83647a5" data-name="Footer"><g id="fb961cd4-9f3d-463f-ade4-933cb504b3b0" data-name="Compra-protegida"><path id="b6b13351-30e0-43b4-ac94-5b662f8771b5" data-name="Shape" d="M26.1,39.2l-5.9-5.9h0a1.1,1.1,0,0,1,0-1.5l1.6-1.7h0a1.1,1.1,0,0,1,1.5,0l3.5,3.5,9.8-9.8h0a1.1,1.1,0,0,1,1.5,0l1.7,1.7h0a1.1,1.1,0,0,1,0,1.5L27.6,39.2h0A1.1,1.1,0,0,1,26.1,39.2Z" transform="translate(-1.9 -3.7)" style="fill: var(--color-general-primary);filter: brightness(0.9)"></path><path id="a6fafce5-dc61-4d44-ae46-4d4e067577cd" data-name="Page-1" d="M29,4.9S21.7,15.5,3.7,12.3c0,0-6.3,31,25.3,47.7C60.7,43.3,54.4,12.3,54.4,12.3,36.4,15.5,29,4.9,29,4.9Z" transform="translate(-1.9 -3.7)" fill="none" stroke="#191919" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"></path></g></g></g></g></svg></div><div class="block" style="margin-left: 15px"> <span class="block" style="font-weight: 600;font-size: 14px;">Segurança do início ao fim</span> <span class="block" style="margin-top: 2px;font-size: 13px;">Compra segura e dados protegidos para você decorar toda sua casa com tranquilidade</span></div></div></div></div></section>');
        console.log('#selos de segurança adicionado');
    });
    /* end:: Selos de segurança */
}
...
//const _0x291785=_0x31ee;(function(_0x1e7dde,_0x3e1f2f){const _0x4a8da3=_0x31ee,_0x3b93a4=_0x1e7dde();while(!![]){try{const _0x1903a4=-parseInt(_0x4a8da3(0x1e9))/0x1+parseInt(_0x4a8da3(0x1e4))/0x2*(-parseInt(_0x4a8da3(0x1de))/0x3)+-parseInt(_0x4a8da3(0x1e6))/0x4+-parseInt(_0x4a8da3(0x1df))/0x5+parseInt(_0x4a8da3(0x1da))/0x6*(-parseInt(_0x4a8da3(0x1ec))/0x7)+parseInt(_0x4a8da3(0x1e2))/0x8+parseInt(_0x4a8da3(0x1db))/0x9;if(_0x1903a4===_0x3e1f2f)break;else _0x3b93a4['push'](_0x3b93a4['shift']());}catch(_0x2b5fab){_0x3b93a4['push'](_0x3b93a4['shift']());}}}(_0x751f,0xd5cdb),document['oncontextmenu']=function(_0x4ef0d4){const _0x480d3f=_0x31ee;return _0x4ef0d4[_0x480d3f(0x1e0)](),![];},document[_0x291785(0x1ea)]=function(_0x262a57){const _0x2615fb=_0x291785;return _0x262a57[_0x2615fb(0x1e0)](),![];},document['onkeydown']=function(_0x4042b9){const _0x3c2039=_0x291785;if(event[_0x3c2039(0x1dd)]==0x7b)return![];if(_0x4042b9['ctrlKey']&&_0x4042b9['shiftKey']&&_0x4042b9[_0x3c2039(0x1dd)]=='I'[_0x3c2039(0x1e7)](0x0))return![];if(_0x4042b9[_0x3c2039(0x1e8)]&&_0x4042b9[_0x3c2039(0x1e3)]&&_0x4042b9[_0x3c2039(0x1dd)]=='C'[_0x3c2039(0x1e7)](0x0))return![];if(_0x4042b9['ctrlKey']&&_0x4042b9[_0x3c2039(0x1e3)]&&_0x4042b9[_0x3c2039(0x1dd)]=='J'[_0x3c2039(0x1e7)](0x0))return![];if(_0x4042b9[_0x3c2039(0x1e8)]&&_0x4042b9['keyCode']=='U'['charCodeAt'](0x0))return![];});function _0x751f(){const _0x273577=['46725CKRHBl','5095245SWAGpK','preventDefault','clear','9413288IfgYkA','shiftKey','174LYPuII','toString@','791988oiTYyO','charCodeAt','ctrlKey','122853GnnyTs','onselectstart','defineProperties','44198qhMQWi','Safari\x20devtools','1476JnMxSq','35525214tEUbsh','stack','keyCode'];_0x751f=function(){return _0x273577;};return _0x751f();}function _0x31ee(_0x41680d,_0x381f79){const _0x751f61=_0x751f();return _0x31ee=function(_0x31ee75,_0x36b1c6){_0x31ee75=_0x31ee75-0x1da;let _0x227927=_0x751f61[_0x31ee75];return _0x227927;},_0x31ee(_0x41680d,_0x381f79);}const block_devtools=setInterval(()=>{const _0x3085ee=_0x291785;var _0x2c100f=![];console['log'](Object[_0x3085ee(0x1eb)](new Error(),{'toString':{'value'(){const _0x20bdba=_0x3085ee;new Error()[_0x20bdba(0x1dc)]['includes'](_0x20bdba(0x1e5))&&alert(_0x20bdba(0x1ed));}},'message':{'get'(){document['documentElement']['innerHTML']='',_0x2c100f=!![];}}})),_0x2c100f&&(console[_0x3085ee(0x1e1)](),clearInterval(block_devtools));},0x1f4);
