...
async function get_tracker(code_value) {
    ...
    var json_result = {}, fetch_count = 0;
    while((fetch_count < 5) && (Object.keys(json_result).length === 0)){
        try{
            json_result = await fetch("https://parcels-tracking.vercel.app/api/track", requestOptions )[m(u("0x66"))]((async t=>{
